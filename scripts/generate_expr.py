...
if len(sys.argv) != 2:
    print("Usage: python3 generate_expr.py <dir_path>")
    exit()
...
def define_ast(types):
    ...
    with open(file_name,"w") as f:
        ...
        for type,attributes in types.items():
            ...
            print("\t\t\treturn visitor.visit"+type+"Expr(this);",file=f)
            print("\t\t}",file=f)
            print("\t}",file=f)
